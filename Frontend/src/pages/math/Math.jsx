...
const Math = () => {
  ...
  const [mobileMenu, setMobileMenu] = useState(
     localStorage.getItem("mathMobileMenu") === "true"
  )

  const [openClass, setOpenClass] = useState(

     localStorage.getItem("mathOpenClass") || null
...
const assignedClass = Number(currentStudent?.assignedClass)  // 🔥 IMPORTANT
...
const fetchStudents = async () => {
  ...
  try {
    ...
    const response = await API.get(
      "/enrollment/approved-students/math",
      {
        headers: {
...
const handleVerifyCode = () => {
  ...
  const fullText = "Welcome to Mathematics Dashboard,"
              ...
              <div key={cls}>
                ...
                {openClass === cls && (
                  ...
                  <div className="ml-4 mt-3 flex flex-col gap-2 text-sm">
                    ...
                    <button
                      onClick={() => navigate(`/math/class/${cls}/info`, {
    state: {
      openClass: cls
    }
  })
                    ...
                    <button
                      onClick={() => navigate(`/math/class/${cls}/performance`, {
    state: {
      openClass: cls
    }
  })
                    ...
                    <button
                      onClick={() => navigate(`/math/class/${cls}/material`, {
    state: {
      openClass: cls
    }
  })
                    ...
                    <button
                      onClick={() => navigate(`/math/class/${cls}/schedule`, {
    state: {
      openClass: cls
    }
  })
                    ...
                    <button
                      onClick={() => navigate(`/math/class/${cls}/fees`, {
    state: {
      openClass: cls
    }
  })
                    ...
                    <div className="ml-3 mt-2 flex flex-col gap-2 text-sm">
                      ...
                      <button
                        onClick={() => {
                          ...
                          navigate(`/math/class/${cls}/performance`)
                        }}
                        className="text-left text-gray-300 hover:text-white"
                      >
                        🏆 <span>Performance</span>
                      ...
                      <button
                        onClick={() => {
                          ...
                          navigate(`/math/class/${cls}/material`)
                        }}
                        className="text-left text-gray-300 hover:text-white"
                      >
                        📄 <span>Study Material</span>
                      ...
                      <button
                        onClick={() => {
                          ...
                          navigate(`/math/class/${cls}/schedule`)
                        }}
                        className="text-left text-gray-300 hover:text-white"
                      >
                        📅 <span>Schedule</span>
